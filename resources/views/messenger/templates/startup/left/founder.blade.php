...
FYI, {{ link_to_route('profile_path', $talent->profile->first_name . ' ' . $talent->profile->last_name, $talent->id) }} has left your project: {{ link_to_route('startup_profile', $startup->name, $startup->url) }}. All things come to an end. :(
