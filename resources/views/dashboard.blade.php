...
@section('content')
	<header class="header">
		<div class="container">
			<img class="profile-image img-responsive img-circle img-thumbnail pull-left" src="{{{ Auth::user()->avatar() }}}?s=180&d=mm" width="180" height="180" alt="{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}">
