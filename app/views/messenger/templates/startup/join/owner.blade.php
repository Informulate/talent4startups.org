...
Congratulations, {{ link_to_route('profile_path', $talent->profile->first_name . ' ' . $talent->profile->last_name, $talent->username) }} has accepted your invitation to join your startup: {{ link_to_route('startup_profile', $startup->name, $startup->url) }}.  Your team is growing!
