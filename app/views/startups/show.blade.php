		...
		<div class="col-md-4">
			...
			@if($startup->owner == $currentUser)
				...
				@foreach($requests as $user)
					<div>
						<a href="{{ route('profile_path', $user->username) }}"><img class="img-circle" src="http://www.gravatar.com/avatar/<?php echo md5( strtolower( trim( $user->email ) ) ) ?>?s=64"> {{ $user->profile->first_name }} {{ $user->profile->last_name }}
